 ...
 * root became a multi-test hub. The IQ runner / result / checkout still
 * live at `/[locale]/test`, `/[locale]/result`, `/[locale]/checkout` so
 * the CTAs and post-purchase flow keep working without further moves.
 */
export default async function IqLandingPage({
  ...
  return (
    <>
      <OrganizationLD name="IQ Test" url={`${base}/${locale}/iq`} locale={loc} />
      <WebsiteLD name="IQ Test" url={`${base}/${locale}/iq`} locale={loc} />
      <ProductLD
        name={tMeta('title')}
