...
export const generateMetadata = makeTestLandingMetadata('enneagram');

const COPY = {
  ko: {
    eyebrow: 'ENNEAGRAM',
    headline: '당신의 본질은\n9유형 중 무엇?',
    sub: '18문항 · 3분이면 끝나는 에니어그램 테스트.\n당신을 움직이는 핵심 동기를 찾아드려요.',
    cta: '시작하기 · 무료',
    bullets: [
      '18문항 · 3분',
      '9가지 유형 핵심 동기 분석',
  ...
  en: {
    ...
    sub: 'An 18-question, 3-minute enneagram test.\nDiscover the core motivation that moves you.',
    cta: 'Start · Free',
    bullets: [
      '18 questions · 3 minutes',
      '9 types, core-motivation analysis',
      'Strengths, weaknesses & top-3 graph',
...
export default function EnneagramLanding({
  params: { locale },
}: {
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-md flex-col px-5 pb-10 pt-12">
      ...
      <header className="text-xs font-semibold uppercase tracking-widest text-teal-600">
        {t.eyebrow}
      </header>
        ...
        <ul className="mt-8 space-y-3 text-sm text-gray-700">
          {t.bullets.map((b) => (
            <li key={b} className="flex items-center gap-3">
              <span className="grid h-6 w-6 place-items-center rounded-full bg-teal-100 text-teal-600">
