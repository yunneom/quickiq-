...
import { scoreAjae, AJAE_TEST_TYPE } from '@/lib/personality/ajae';
...
export const POST = withErrorHandling('personality/ajae/submit', async (req: Request) => {
  const bypass =
    isRateLimitDisabled() ||
  ...
  const result = scoreAjae(body.answers, locale);
