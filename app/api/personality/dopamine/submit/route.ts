...
import { scoreDopamine, DOPAMINE_TEST_TYPE } from '@/lib/personality/dopamine';
...
export const POST = withErrorHandling('personality/dopamine/submit', async (req: Request) => {
  const bypass =
    isRateLimitDisabled() ||
  ...
  const result = scoreDopamine(body.answers, locale);
