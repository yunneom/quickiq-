...
import { scoreMbti, MBTI_TEST_TYPE } from '@/lib/personality/mbti';
...
export const POST = withErrorHandling('personality/mbti/submit', async (req: Request) => {
  const bypass =
    isRateLimitDisabled() ||
  ...
  const result = scoreMbti(body.answers, locale);
