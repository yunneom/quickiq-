...
import { scoreLoveLang, LOVE_LANG_TEST_TYPE } from '@/lib/personality/love-lang';
...
export const POST = withErrorHandling('personality/love-lang/submit', async (req: Request) => {
  const bypass =
    isRateLimitDisabled() ||
  ...
  const result = scoreLoveLang(body.answers, locale);
